...
public class RedisOMAutoConfiguration {
     ...
     */
    public RedisOMAutoConfiguration() {
        // Default constructor for Spring instantiation
    }

    private static final Log logger = LogFactory.getLog(RedisOMAutoConfiguration.class);
     ...
     * @param redisTemplate the string Redis template for basic operations
    ...
    RedisModulesOperations<?> redisModulesOperations( //
        ...
        return new RedisModulesOperations<>(rmc, redisTemplate, gsonBuilder);
    }
     ...
     *
     * @param redisTemplate          the Redis operations template
    ...
    RedisJSONKeyValueAdapter getRedisJSONKeyValueAdapter( //
        ...
        return new RedisJSONKeyValueAdapter(redisTemplate, redisModulesOperations, mappingContext, indexer, gsonBuilder,
                embedder, properties);
    }
    ...
    public CustomRedisKeyValueTemplate getRedisJSONKeyValueTemplate( //
        ...
        return new CustomRedisKeyValueTemplate(new RedisJSONKeyValueAdapter(redisTemplate, redisModulesOperations,
    ...
    public CustomRedisKeyValueTemplate getKeyValueTemplate( //
        ...
        return new CustomRedisKeyValueTemplate(new RedisEnhancedKeyValueAdapter(redisTemplate, redisModulesOperations,
